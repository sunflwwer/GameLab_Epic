...
namespace GMTK.PlatformerToolkit {
    ...
    public class characterJump : MonoBehaviour {
        ...
        [SerializeField, Range(1f, 10f)][Tooltip("Gravity multiplier to apply when coming down")] public float downwardMovementMultiplier = 4f;
        ...
        private void calculateGravity() {
            ...
            //Else if going down...
                ...
                //Don't change it if Kit is stood on something (such as a moving platform)
                {
                    ...
                    if (slowFalling) {
                        gravMultiplier = slowFallMultiplier;
                    }
                    else {
